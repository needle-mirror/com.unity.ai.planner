...
{
    struct PlanGraph<TStateKey, TStateInfo, TActionKey, TActionInfo, TStateTransitionInfo>
    ...
    public struct StateInfo : IStateInfo
    {
        ...
        /// favor of branches with higher estimated reward values.
        /// </summary>
        public bool SubplanIsComplete;

        BoundedValue IStateInfo.CumulativeRewardEstimate => CumulativeRewardEstimate;
        bool IStateInfo.SubplanIsComplete => SubplanIsComplete;
    }
    ...
    public struct ActionInfo : IActionInfo
    {
        ...
        BoundedValue IActionInfo.CumulativeRewardEstimate => CumulativeRewardEstimate;
        bool IActionInfo.SubplanIsComplete => SubplanIsComplete;
    }
